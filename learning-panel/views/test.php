...
<div class="animate-fade-in-up max-w-3xl mx-auto">
    <?php if (!$test_data): ?>
        <div class="glass-card rounded-2xl shadow-xl p-12 text-center">
            ...
            <h2 class="text-3xl font-black text-gray-800 dark:text-white mb-4">خطا در بارگذاری</h2>
            <p class="text-lg text-gray-600 dark:text-gray-400">محتوای آزمون یافت نشد. لطفاً با مدیر سیستم تماس بگیرید.</p>
        </div>
    <?php else: ?>
        <div class="space-y-6">
            <!-- هدر -->
